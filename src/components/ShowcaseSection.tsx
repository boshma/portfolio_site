    ...
    <div id="showcase" className="container mx-auto text-center py-8">
      ...
      <div className="flex flex-col md:flex-row justify-center">
        <div className="w-full md:w-1/2 p-4">
          <p className="text-2xl md:text-4xl text-blue-200 font-semibold mb-4">All in one Fitness App!</p>
          <ul className="text-xl md:text-2xl text-blue-200 font-serif">
        ...
        <div className="w-full md:w-1/2 p-4">
          <p className="text-2xl md:text-4xl font-semibold mb-4 text-blue-200">TODO</p>
          <ul className="text-xl md:text-2xl text-blue-200 font-serif">
