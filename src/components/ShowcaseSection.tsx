    ...
    <div id="showcase" className="container mx-auto text-center py-8">
      ...
      <div className="flex justify-center">
        <div className="w-1/2 p-4">
          <p className="text-4xl text-blue-200 font-semibold mb-4">All in one Fitness App!</p>
          <ul className="text-2xl text-blue-200 font-serif">
        ...
        <div className="w-1/2 p-4">
          <p className="text-4xl font-semibold mb-4 text-blue-200">TODO</p>
          <ul className="text-2xl text-blue-200 font-serif">
      ...
      <p className="text-2xl font-semibold mb-4 text-blue-800"> <a target="_blank" href="https://github.com/boshma">Check out my other projects in Kotlin, Java and Django</a> </p>
    </div>
  );
};
